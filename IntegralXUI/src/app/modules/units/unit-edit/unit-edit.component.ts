  ...
  loaddetails() {
    this.unitService.getUnitDetails(this.childValue).subscribe((unitData: any) => {
      ...
      this.unitForm.patchValue({
        ...
        unitFunctionality: unitData.unitFunctionality || '',
      ...
      utilityRequirements:unitData.utilityRequirements || '',
        ...
        subsequentMajorOverhaulDate: unitData.subsequentMajorOverhaulDate ? new Date(unitData.subsequentMajorOverhaulDate).toLocaleDateString('en-CA') : null,
        mtbf: unitData.mtbf || '',
        mttr: unitData.mttr || '',
        inspectionSupervisor: unitData.inspectionSupervisor || '',
        inspector: unitData.inspector || '',
